    ...
    <div className="home">
      <nav className="site-nav" aria-label="Primary">
        ...
        <div className="links">
          ...
          <Link href="/call" className="nav-auth">
            Call Now
          </Link>
        </div>
      </nav>
      ...
      <header className="hero">
        ...
        <p className="tap">
          {dialNumber
            ? "Call from your phone · or use browser demo below"
            : "Use the browser demo to start"}
        </p>
        <Link
          href="/call"
          style={{
      ...
      <section className="section" id="how">
        <div className="section-inner">
          ...
          <p className="body">
            Dial from any handset. Vapi connects you to the voice agent.
          ...
          <div className="steps">
            <div className="step">
              ...
              <strong>Dial</strong>
              <p>Vapi connects you to the agent.</p>
            </div>
            <div className="step">
